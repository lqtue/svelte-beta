...
- [ ] Apply `supabase/migrations/018_sam_pipeline.sql` and `019_needs_review_status.sql`
  ```bash
...
- [x] Download SAM2 checkpoint → `sam2.1_hiera_large.pt` (~900MB)
  ```bash
...
Logic (documented in `VMA_VECTORIZATION_METHODOLOGY.md` §10):
...
- [ ] Review `VMA_VECTORIZATION_METHODOLOGY.md`
