...
import { Point, Line, Size, FetchFn, ImageInformations, Color, Bbox, TileZoomLevel } from '@allmaps/types';
...
export type WebGL2WarpedMapOptions = SpecificWebGL2WarpedMapOptions & TriangulatedWarpedMapOptions;
...
export type WebGL2RendererOptions = {
    ...
    debugMaps: boolean;
} & WebGL2WarpedMapOptions & BaseRendererOptions;
...
export type WarpedMapFactory<W> = (mapId: string, georeferencedMap: GeoreferencedMap, options?: Partial<WarpedMapOptions>) => W;
export type CachableTileFactory<D> = (fetchableTile: FetchableTile, fetchFn?: FetchFn) => CacheableTile<D>;
