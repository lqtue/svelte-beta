...
var image1ProfileUriRegex = /^https?:\/\/library.stanford.edu\/iiif\/image-api\/1.1\/compliance.html#level(?<level>[012])$/;
var Image1ProfileUri = external_exports.string().regex(image1ProfileUriRegex);
var Image1ProfileSchema = Image1ProfileUri;
var Image1ContextString = "http://library.stanford.edu/iiif/image-api/1.1/context.json";
var Image1ContextStringIncorrect = "http://iiif.io/api/image/1/context.json";
var Image1Context = external_exports.literal(Image1ContextString);
var Image1Schema = external_exports.object({
...
var TilesetSchema = external_exports.object({
  width: external_exports.number().int(),
...
var ImageServiceTypesSchema = external_exports.enum(imageServiceTypes);
var ValidNavDateSchema = external_exports.coerce.date();
var NavDateSchema = external_exports.union([
  ValidNavDateSchema,
...
var NavPlaceSchema = external_exports.object({}).passthrough();

// node_modules/@allmaps/iiif-parser/dist/schemas/image.2.js
var image2ProfileUriRegex = /^https?:\/\/iiif.io\/api\/image\/2.*level(?<level>[012])(.json)?$/;
var Image2ProfileUri = external_exports.string().regex(image2ProfileUriRegex);
var Image2ProfileDescriptionSchema = external_exports.object({
...
var ValidImage2ProfileArrayItemSchema = external_exports.union([
  Image2ProfileUri,
...
var Image2ProfileSchema = external_exports.union([
  Image2ProfileUri,
...
var Image2ContextString = "http://iiif.io/api/image/2/context.json";
var Image2Context = external_exports.union([
...
var Image2Schema = external_exports.object({
  "@id": external_exports.string().url(),
...
var image3Profiles = ["level0", "level1", "level2"];
var Image3ProfileSchema = external_exports.enum(image3Profiles);
var Image3Schema = external_exports.object({
  id: external_exports.string().url(),
...
var ImageService2Schema = external_exports.object({
  "@id": external_exports.string().url(),
...
var complianceLevels = ["level0", "level1", "level2"];
var Presentation3ImageService2Schema = external_exports.union([
...
var Presentation3ImageService3Schema = external_exports.object({
  id: external_exports.string().url(),
  type: ImageServiceTypesSchema,
  profile: external_exports.enum(complianceLevels)
});
var ImageService3Schema = external_exports.union([
...
var ImageServiceSchema = external_exports.union([
  ImageService2Schema,
  ImageService3Schema
]);

// node_modules/@allmaps/iiif-parser/dist/lib/convert.js
var LanguageString3Schema = external_exports.record(external_exports.string(), external_exports.string().array());
var MetadataStringItem3Schema = external_exports.object({
...
var SingleValue2Schema = external_exports.union([external_exports.string(), external_exports.number(), external_exports.boolean()]).transform((val) => String(val));
var Value2Schema = external_exports.union([
  SingleValue2Schema.array(),
  SingleValue2Schema
]);
var RelatedItem2Schema = external_exports.object({
  "@id": external_exports.string().url(),
  format: external_exports.string().optional(),
  label: Value2Schema.optional()
});
var Related2Schema = external_exports.union([
  RelatedItem2Schema.array(),
  RelatedItem2Schema,
  SingleValue2Schema
]);
var ThumbnailItem2Schema = external_exports.union([
...
var Thumbnail2Schema = external_exports.union([ThumbnailItem2Schema.array(), ThumbnailItem2Schema]).transform(ensureArray);
var RenderingItem2Schema = external_exports.object({
  "@id": external_exports.string().url(),
  "@type": external_exports.string().optional(),
  label: Value2Schema.optional(),
  format: external_exports.string().optional()
});
var Rendering2Schema = external_exports.union([RenderingItem2Schema.array(), RenderingItem2Schema]).transform(ensureArray);
var ValidLanguageValue2Schema = external_exports.union([
...
var LanguageValue2Schema = ValidLanguageValue2Schema;
var PossibleLanguageValue2Schema = external_exports.union([
  LanguageValue2Schema.array(),
  LanguageValue2Schema,
  Value2Schema
]);
var Attribution2Schema = external_exports.union([
  external_exports.string(),
  PossibleLanguageValue2Schema
]);
var ValidMetadataItem2Schema = external_exports.object({
  label: PossibleLanguageValue2Schema.optional(),
  value: PossibleLanguageValue2Schema.optional()
});
var MetadataItem2Schema = external_exports.union([
...
var Metadata2Schema = MetadataItem2Schema.array();
var ImageResource2Schema = external_exports.object({
  width: external_exports.number().int().optional(),
  height: external_exports.number().int().optional(),
  service: ImageServiceSchema
});
var Annotation2Schema = external_exports.object({
  resource: ImageResource2Schema
});
var Canvas2Schema = external_exports.object({
  "@id": external_exports.string().url(),
...
var Sequence2Schema = external_exports.object({
  canvases: Canvas2Schema.array().nonempty()
});
var Manifest2Schema = external_exports.object({
  "@id": external_exports.string().url(),
...
var EmbeddedManifest2Schema = external_exports.lazy(() => external_exports.object({
  "@id": external_exports.string().url(),
  "@type": external_exports.literal("sc:Manifest"),
  label: PossibleLanguageValue2Schema.optional()
}));
var Collection2Schema = external_exports.lazy(() => external_exports.object({
  "@id": external_exports.string().url(),
...
var EmbeddedCollection2Schema = external_exports.object({
  "@id": external_exports.string().url(),
  "@type": external_exports.literal("sc:Collection"),
  label: PossibleLanguageValue2Schema.optional()
});
...
var SingleValue3Schema = external_exports.union([external_exports.string(), external_exports.number(), external_exports.boolean()]).transform((val) => String(val));
var LanguageValue3Schema = external_exports.record(external_exports.string(), SingleValue3Schema.array());
var Summary3Schema = LanguageValue3Schema;
var HomepageItem3Schema = external_exports.object({
  id: external_exports.string().url(),
  type: external_exports.string().optional(),
...
var Rendering3ItemSchema = external_exports.object({
  id: external_exports.string().url(),
  type: external_exports.string().optional(),
  label: LanguageValue3Schema,
  format: external_exports.string().optional()
});
var Rendering3Schema = external_exports.union([Rendering3ItemSchema.array(), Rendering3ItemSchema]).transform(ensureArray);
var Homepage3Schema = external_exports.union([HomepageItem3Schema.array(), HomepageItem3Schema]).transform(ensureArray);
var ThumbnailItem3Schema = external_exports.object({
  id: external_exports.string().url(),
  type: external_exports.string().optional(),
  format: external_exports.string().optional(),
  width: external_exports.number().int().optional(),
...
var Thumbnail3Schema = external_exports.union([ThumbnailItem3Schema.array(), ThumbnailItem3Schema]).transform(ensureArray);
var SeeAlsoItem3Schema = external_exports.object({
  id: external_exports.string().url(),
  type: external_exports.string().optional(),
  format: external_exports.string().optional(),
  profile: external_exports.string().optional()
});
var SeeAlso3Schema = external_exports.union([SeeAlsoItem3Schema.array(), SeeAlsoItem3Schema]).transform(ensureArray);
var NonPaintingAnnotations3 = external_exports.object({
  id: external_exports.string().url(),
  type: external_exports.literal("AnnotationPage"),
  items: external_exports.object({}).passthrough().array().optional()
}).array();
var ValidMetadataItem3Schema = external_exports.object({
  label: LanguageValue3Schema,
  value: LanguageValue3Schema
});
var MetadataItem3Schema = external_exports.union([
...
var Metadata3Schema = MetadataItem3Schema.array();
var RequiredStatement3Schema = MetadataItem3Schema;
var AnnotationBody3Schema = external_exports.object({
  type: external_exports.literal("Image"),
  width: external_exports.number().int().optional(),
  height: external_exports.number().int().optional(),
  service: ImageServiceSchema.array()
});
var Choice3Schema = external_exports.object({
  type: external_exports.literal("Choice"),
  items: AnnotationBody3Schema.array()
});
var Annotation3Schema = external_exports.object({
...
var AnnotationPage3Schema = external_exports.object({
  type: external_exports.literal("AnnotationPage"),
...
var Manifest3Schema = external_exports.object({
  id: external_exports.string().url(),
...
var EmbeddedManifest3Schema = external_exports.lazy(() => external_exports.object({
  id: external_exports.string().url(),
  type: external_exports.literal("Manifest"),
  label: LanguageValue3Schema.optional()
}));
var Collection3Schema = external_exports.lazy(() => external_exports.object({
  id: external_exports.string().url(),
...
var EmbeddedCollection3Schema = external_exports.object({
  id: external_exports.string().url(),
  type: external_exports.literal("Collection"),
  label: LanguageValue3Schema.optional()
});
...
var ImageSchema = external_exports.union([Image1Schema, Image2Schema, Image3Schema]);
var CanvasSchema = external_exports.union([Canvas2Schema, Canvas3Schema]);
var ManifestSchema = external_exports.union([Manifest2Schema, Manifest3Schema]);
var CollectionSchema = external_exports.union([Collection2Schema, Collection3Schema]);
var IIIF1Schema = Image1Schema;
var IIIF2Schema = external_exports.union([
  Collection2Schema,
  Manifest2Schema,
  Canvas2Schema,
  Image2Schema
]);
var IIIF3Schema = external_exports.union([
  Collection3Schema,
  Manifest3Schema,
  Canvas3Schema,
  Image3Schema
]);
var IIIFSchema = external_exports.union([IIIF1Schema, IIIF2Schema, IIIF3Schema]);
...
var maxThumbnailDownscale = 0.8;
var maxThumbnailUpscale = 1.5;
function getImageRequest(imageSize, containerSize, mode = "cover", { sizes, tileZoomLevels, supportsAnyRegionAndSize, maxWidth, maxHeight, maxArea }) {
  ...
  if (tileZoomLevels) {
    ...
    const nearestZoomLevels = tileZoomLevels.map(({ scaleFactor }, index) => ({
      index,
      scaleFactor,
...
var anyRegionAndSizeFeatures = ["regionByPx", "sizeByWh"];
...
var ImageTypeString = "image";
var EmbeddedImage = class {
  embedded = true;
  uri;
...
var Image = class _Image extends EmbeddedImage {
  tileZoomLevels;
  sizes;
  embedded = false;
...
var ManifestTypeString = "manifest";
var EmbeddedManifest = class {
  embedded = true;
  uri;
...
var Manifest = class _Manifest extends EmbeddedManifest {
  canvases = [];
  description;
  metadata;
  navDate;
...
var CollectionTypeString = "collection";
...
var Collection = class _Collection extends EmbeddedCollection {
  items = [];
  embedded = false;
  description;
  metadata;
...
//# sourceMappingURL=chunk-WNZSJ6TY.js.map
