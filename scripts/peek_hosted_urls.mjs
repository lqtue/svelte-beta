...
const r = await fetch(
  `${env.PUBLIC_SUPABASE_URL}/rest/v1/maps?select=id,name,source_type,iiif_manifest,iiif_image,source_url,allmaps_id,extra_metadata&source_type=in.(bnf,ia)&order=source_type.asc`,
  {
    headers: {
