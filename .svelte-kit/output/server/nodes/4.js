...
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/trip/_page.svelte.js')).default;
...
export const stylesheets = ["_app/immutable/assets/ol.BtPuoxOl.css","_app/immutable/assets/4.D-NxuxNd.css"];
export const fonts = [];
