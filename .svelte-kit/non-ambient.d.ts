...
declare module "$app/types" {
	export interface AppTypes {
		...
		Pathname(): "/" | "/about" | "/about/" | "/annotate" | "/annotate/" | "/api" | "/api/" | "/api/admin" | "/api/admin/" | "/api/admin/footprints" | "/api/admin/footprints/" | "/api/admin/maps" | "/api/admin/maps/" | "/api/admin/maps/fetch-iiif-metadata" | "/api/admin/maps/fetch-iiif-metadata/" | `/api/admin/maps/${string}` & {} | `/api/admin/maps/${string}/` & {} | `/api/admin/maps/${string}/annotation` & {} | `/api/admin/maps/${string}/annotation/` & {} | `/api/admin/maps/${string}/iiif-sources` & {} | `/api/admin/maps/${string}/iiif-sources/` & {} | `/api/admin/maps/${string}/iiif-sources/${string}` & {} | `/api/admin/maps/${string}/iiif-sources/${string}/` & {} | `/api/admin/maps/${string}/image` & {} | `/api/admin/maps/${string}/image/` & {} | `/api/admin/maps/${string}/mirror-r2` & {} | `/api/admin/maps/${string}/mirror-r2/` & {} | `/api/admin/maps/${string}/ocr-review` & {} | `/api/admin/maps/${string}/ocr-review/` & {} | `/api/admin/maps/${string}/ocr-review/revert-recent` & {} | `/api/admin/maps/${string}/ocr-review/revert-recent/` & {} | `/api/admin/maps/${string}/ocr` & {} | `/api/admin/maps/${string}/ocr/` & {} | `/api/admin/maps/${string}/ocr/apply` & {} | `/api/admin/maps/${string}/ocr/apply/` & {} | "/api/admin/upload-image" | "/api/admin/upload-image/" | "/api/export" | "/api/export/" | "/api/export/footprints" | "/api/export/footprints/" | "/auth" | "/auth/" | "/auth/callback" | "/auth/callback/" | "/blog" | "/blog/" | `/blog/${string}` & {} | `/blog/${string}/` & {} | "/catalog" | "/catalog/" | "/contribute" | "/contribute/" | "/contribute/digitalize" | "/contribute/digitalize/" | "/contribute/georef" | "/contribute/georef/" | "/contribute/label" | "/contribute/label/" | "/contribute/review" | "/contribute/review/" | "/contribute/trace" | "/contribute/trace/" | "/create" | "/create/" | "/image" | "/image/" | "/login" | "/login/" | "/profile" | "/profile/" | "/view" | "/view/";
