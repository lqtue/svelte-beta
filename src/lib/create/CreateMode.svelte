<!--
  ...
  Point CRUD lives in $lib/story/pointOps, preview state in
  $lib/story/previewSession, and the sample story in ./saigonSeed.
...
<script lang="ts">
  ...
  import * as pointOps from '$lib/story/pointOps';
  import {
    CLOSED_PREVIEW,
    closePreview,
