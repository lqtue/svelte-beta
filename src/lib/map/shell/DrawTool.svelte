<script lang="ts">
  ...
  import {
    ...
    searchResultStyle,
  } from '$lib/map/annotations/olAnnotations';
  import type { FeatureSnapshot } from '$lib/map/annotations/annotationHistory';
  import { createAnnotationCommands } from '$lib/map/annotations/annotationCommands';
