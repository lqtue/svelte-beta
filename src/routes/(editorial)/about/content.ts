...
export const layers: Layer[] = [
  {
    ...
    built: [
      ...
      'A first OCR pass has read 1,767 place names off six of those sheets, and each name links back to the exact spot on the exact sheet it came from',
    ...
    building: [
      ...
      'Checking what the OCR read: 43 labels of 1,767 confirmed by a person so far, so this queue has barely started, and until it moves the label search stays thin',
